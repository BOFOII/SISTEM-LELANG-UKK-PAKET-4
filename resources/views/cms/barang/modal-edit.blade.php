        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    ...
                    <p>Masukan data barang pada form di bawah untuk memperbaruhi barang.</p>
                </div>
                <form id="main-form" class="row gy-1 pt-75" action="{{ route('patch.barang.cms', [
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        @enderror"
                            ...
                            name="nama_barang" value="{{ old('nama_barang', $barang_detail->nama_barang) }}" />
                        @error('nama_barang')
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input type="text" id="basic-icon-default-harga_awal"
                            class="form-control dt-harga_awal @error('harga_awal')
                              error
                            @enderror"
                            placeholder="contoh: 100000" name="harga_awal" value="{{ old('harga_awal', $barang_detail->harga_awal) }}" />
                        @error('harga_awal')
                    ...
                    <div class="col-12 position-relative">
                        ...
                        <input type="text" id="basic-icon-default-tgl"
                            class="form-control pickadate @error('tgl')
                                error
                            @enderror" placeholder="6 April, 2023" name="tgl" value="{{ old('tgl', $barang_detail->tgl) }}"/>
                        @error('tgl')
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-floating mb-0">
                            <textarea data-length="20"
                              ...
                              error
                            @enderror"
                                id="textarea-counter" name="deskripsi_barang" rows="3" placeholder="Counter" style="height: 100px">{{ old('deskripsi_barang', $barang_detail->deskripsi_barang) }}</textarea>
                        </div>
                    ...
                    @if (empty($barang_detail->images) == false)
                        @foreach ($barang_detail->images as $image)
                        <input type="text" class="d-none" value="{{ $image->url }}" name="images[]">
