    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <form id="main-form"
                    action="{{ route('patch.petugas.cms', [
                        'petugas' => $petugas_detail,
                    ]) }}"
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        @enderror"
                            ...
                            value="{{ old('nama_petugas', $petugas_detail->nama_petugas) }}" />
                        @error('nama_petugas')
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        error
                        @enderror"
                            placeholder="contoh: Zalpha" name="username"
                            value="{{ old('username', $petugas_detail->username) }}" />
                        @error('username')
                            <span id="basic-default-name-error" class="error">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6">
                        ...
                        @enderror"
                            ...
                            @foreach ($level_list as $level)
                                <option @if (old('id_level', $petugas_detail->id_level) == $level->id_level) @selected(true) @endif
                    ...
                    @if (empty(old('image', $petugas_detail->avatar == null ? null : $petugas_detail->avatar->url)) == false)
